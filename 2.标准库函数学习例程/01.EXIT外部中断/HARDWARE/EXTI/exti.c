...
//外部中断 驱动代码
//extix_init中根据需要删减，最下面三个外部中断服务程序根据需要重写或删减
//外部中断0服务程序
void extix_init(void)
{
    ...
    //GPIOE.3 KEY1	  中断线以及中断初始化配置 下降沿触发
  	GPIO_EXTILineConfig(GPIO_PortSourceGPIOE,GPIO_PinSource3);    //AFIO将GPIO引脚与外部中断线关联起来
	...
	EXTI_InitStructure.EXTI_LineCmd = ENABLE;
  	...
  	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 0x01;  //抢占优先级5
