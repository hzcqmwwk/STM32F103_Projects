...
//由于定时器TIM3的通道2 TIM3_CH2默认接在PA7，若要接到LED0的PB5上，需要引脚复用功能重映像，详细参照中文手册P119
void pwm_init(uint16_t arr,uint16_t psc)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO|RCC_APB2Periph_GPIOB, ENABLE);  //使能复用时钟和PB端口时钟
